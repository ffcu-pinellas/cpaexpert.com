    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-bold text-2xl text-slate-800 leading-tight">
                {{ __('Edit Testimonial') }}: <span class="text-indigo-600">{{ $testimonial->client_name }}</span>
            </h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="client_name" id="client_name" value="{{ old('client_name', $testimonial->client_name) }}" class="w-full rounded-lg border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all shadow-sm" placeholder="e.g. Robert Smith" required>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="6" class="w-full rounded-lg border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all shadow-sm" placeholder="What the client said..." required>{{ old('content', $testimonial->content) }}</textarea>
